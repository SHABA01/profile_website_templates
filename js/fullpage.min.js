...
!function(e, t, n, o, i) {
    ...
    function Le(n, o, i) {
        var r;
        i = void 0 === i ? {} : i,
        "function" == typeof e.CustomEvent ? r = new CustomEvent(o,{
            detail: i
    ...
    function(P, F) {
        ...
        if (!Q(K("html"), a)) {
            ...
            var Se, Me, He, Ie, Re = !1, Be = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), ze = "ontouchstart"in e || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, Ne = "string" == typeof P ? K(P)[0] : P, je = G(), Pe = !1, De = !0, Ve = !0, Ye = [], Ue = {
                m: {
                    up: !0,
                    down: !0,
                    left: !0,
            ...
            }, Ze = 'a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable]', et = q({}, F);
            jn(),
            ...
            de.destroy = function(n) {
                ...
                clearTimeout(Xe),
                n && (Rn(0),
                K("img[data-src], source[data-src], audio[data-src], iframe[data-src]", Ne).forEach(function(e) {
                    Gt(e, "src")
                }),
                ...
                K(h + ", " + M).forEach(function(e) {
                    F.scrollOverflowHandler && F.scrollOverflowHandler.remove(e),
                    ue(e, B + " " + c + " " + f);
            ...
            F.css3 && (F.css3 = function() {
                ...
                i)
                    void 0 !== o.style[r] && (o.style[r] = "translate3d(1px,1px,1px)",
            ...
            function() {
                ...
                for (var e = K(h), i = 0; i < e.length; i++) {
                    ...
                    void 0 !== F.anchors[S] && m.setAttribute("data-anchor", F.anchors[S]),
                    d = s,
                    v = r,
                    void 0 !== F.anchors[v] && Q(d, c) && bn(F.anchors[v], v),
                    F.menu && F.css3 && null != he(K(F.menu)[0], o) && se.appendChild(K(F.menu)[0]),
                ...
                F.navigation && function() {
                    ...
                    for (var i = "", r = 0; r < K(h).length; r++) {
                        ...
                        i += '<li><a href="#' + l + '"><span class="fp-sr-only">' + Ht(r, "Section") + "</span><span></span></a>";
                        var a = F.navigationTooltips[r];
                        void 0 !== a && "" !== a && (i += '<div class="' + L + " fp-" + F.navigationPosition + '">' + a + "</div>"),
                        i += "</li>"
                    }
        ...
        function ht(n) {
            ...
            Ne.addEventListener("mouseup", cn)) : (t.addEventListener ? (t.removeEventListener("mousewheel", Yt, !1),
            t.removeEventListener("wheel", Yt, !1),
            t.removeEventListener("MozMousePixelScroll", Yt, !1)) : t.detachEvent("onmousewheel", Yt),
        ...
        function mt(e) {
            e ? (ht(!0),
            (Be || ze) && (F.autoScrolling && (se.removeEventListener(Je.touchmove, Nt, {
                passive: !1
            }),
            ...
            K(o)[0].removeEventListener(Je.touchmove, jt, {
                passive: !1
            }),
            K(o)[0].addEventListener(Je.touchstart, Dt),
            K(o)[0].addEventListener(Je.touchmove, jt, {
                passive: !1
            }))) : (ht(!1),
            (Be || ze) && (F.autoScrolling && (se.removeEventListener(Je.touchmove, jt, {
                passive: !1
            }),
        ...
        function Tt(t) {
            if (!Q(Ne, l)) {
                ...
                s && yt(s + 1),
                Pe = !1,
                Ee(F.afterResize) && t && F.afterResize.call(Ne, e.innerWidth, e.innerHeight),
        ...
        function At(e) {
            ...
            le(K(E)),
            ce(se, i),
            Ee(F.afterResponsive) && F.afterResponsive.call(Ne, e)) : t && (ft(et.autoScrolling, "internal"),
        ...
        function Ct(e, n, o) {
            ...
            o > 1 && (F.controlArrows && (a = e,
            s = [Ae('<div class="' + Y + '"></div>'), Ae('<div class="' + W + '"></div>')],
            ge(K(H, a)[0], s),
            "#fff" !== F.controlArrowColor && ($(K(X, a), {
            ...
            F.slidesNavigation && function(e, t) {
        ...
        function It() {
            ...
            (!(e = xn(rn().section)) || void 0 !== e && ie(e) === ie(Ie)) && Ee(F.afterLoad) && Xt("afterLoad", {
                activeSection: null,
                element: t,
                direction: null,
        ...
        function Rt() {
            ...
            if (!F.autoScrolling || F.scrollBar) {
                ...
                i = K(g)[0].offsetTop,
                r = i + G(),
                ("up" == o ? r >= be() + G() : i <= be()) && (Q(K(g)[0], f) || (ce(K(g)[0], f),
                ue(we(K(g)[0]), f))),
                !Q(e = v[s], c)) {
                    tt = !0;
                    var m, S, b = K(g)[0], w = ie(b, h) + 1, y = wn(e), E = e.getAttribute("data-anchor"), L = ie(e, h) + 1, x = K(O, e)[0], T = {
                        activeSection: b,
                        sectionIndex: L - 1,
                        anchorLink: E,
                        element: e,
                    ...
                    x && (S = x.getAttribute("data-anchor"),
                    m = ie(x)),
                    Ve && (ce(e, c),
                    ue(we(e), c),
                ...
                F.fitToSection && (clearTimeout(qe),
            ...
            if (Ue.m[e]) {
                ...
                if (F.scrollOverflow) {
                    var n = F.scrollOverflowHandler.scrollable(K(g)[0])
                      , o = "down" === e ? "bottom" : "top";
                    if (null != n) {
                        if (!F.scrollOverflowHandler.isScrolled(o, n))
                            return !0;
                        t()
                    } else
                        t()
        ...
        function jt(t) {
            ...
            if (Pt(t)) {
                ...
                rt = o.y,
                lt = o.x,
                K(H, n).length && Math.abs(it - lt) > Math.abs(ot - rt) ? !Re && Math.abs(it - lt) > e.innerWidth / 100 * F.touchSensitivity && (it > lt ? Ue.m.right && Lt(n) : Ue.m.left && xt(n)) : F.autoScrolling && Ve && Math.abs(ot - rt) > e.innerHeight / 100 * F.touchSensitivity && (ot > rt ? zt("down") : rt > ot && zt("up"))
            }
        }
        function Pt(e) {
        ...
        function Wt(e, t, n) {
            if (null != e) {
                var o, i, r, l, a, s, u, f, d, v = {
                    ...
                    callback: t,
                    isMovementUp: n,
                    dtop: (i = (o = e).offsetHeight,
                    r = o.offsetTop,
                    a = r > st,
                    s = (l = r) - je + i,
                    u = F.bigSectionsDestination,
                    i > je ? (a || u) && "bottom" !== u || (l = s) : (a || Pe && null == ne(o)) && (l = s),
                    st = l,
                    l),
                    yMovement: wn(e),
                ...
                if (!(v.activeSection == e && !Pe || F.scrollBar && be() === v.dtop && !Q(e, b))) {
                    if (null != v.activeSlide && (f = v.activeSlide.getAttribute("data-anchor"),
                    d = ie(v.activeSlide)),
                    Ee(F.onLeave) && !v.localIsResizing) {
                        var p = v.yMovement;
                        if (void 0 !== n && (p = n ? "up" : "down"),
                        v.direction = p,
                        !1 === Xt("onLeave", v))
                            return
                    }
                    F.autoScrolling && F.continuousVertical && void 0 !== v.isMovementUp && (!v.isMovementUp && "up" == v.yMovement || v.isMovementUp && "down" == v.yMovement) && ((m = v).isMovementUp ? me(K(g)[0], Oe(m.activeSection, h)) : ge(K(g)[0], Ce(m.activeSection, h).reverse()),
                    Rn(K(g)[0].offsetTop),
                    Ft(),
                    ...
                    function(e) {
                        if (F.css3 && F.autoScrolling && !F.scrollBar) {
                            ...
                            Ln(t, !0),
                            F.scrollingSpeed ? (clearTimeout(Xe),
        ...
        function Xt(e, t) {
            ...
            if (F.v2compatible) {
                if (!1 === F[e].apply(l[0], l.slice(1)))
                    return !1
            } else if (Le(Ne, e, l),
            !1 === F[e].apply(l[Object.keys(l)[0]], (n = l,
        ...
        function qt(t) {
            var n = {};
            return F.autoScrolling && !F.scrollBar ? (n.options = -t,
            n.element = K(o)[0]) : (n.options = t,
            n.element = e),
            n
        }
        function Qt(e) {
            var t;
            null != (t = e).wrapAroundElements && (t.isMovementUp ? me(K(h)[0], t.wrapAroundElements) : ge(K(h)[K(h).length - 1], t.wrapAroundElements),
            Rn(K(g)[0].offsetTop),
            Ft()),
        ...
        function ln(e) {
            ...
            var n = t.activeElement
              , o = e.keyCode;
            9 === o ? function(e) {
                var n, o, i, r, l, a, s, c = e.shiftKey, u = t.activeElement, f = un(tn(K(g)[0]));
                function d(e) {
                    return ye(e),
                    f[0] ? f[0].focus() : null
                }
                ...
                a = Kt(he(l, M)),
                s = _t(he(l, h)),
                a || s) && (u ? null == he(u, g + "," + g + " " + O) && (u = d(e)) : d(e),
                (!c && u == f[f.length - 1] || c && u == f[0]) && ye(e))
            }(e) : xe(n, "textarea") || xe(n, "input") || xe(n, "select") || "true" === n.getAttribute("contentEditable") || "" === n.getAttribute("contentEditable") || !F.keyboardScrolling || !F.autoScrolling || ([40, 38, 32, 33, 34].indexOf(o) > -1 && ye(e),
            He = e.ctrlKey,
            Qe = setTimeout(function() {
                !function(e) {
                    var t = e.shiftKey;
        ...
        function sn(e) {
            2 == e.which && (ct = e.pageY,
            Ne.addEventListener("mousemove", dn))
        }
        function cn(e) {
        ...
        function dn(e) {
            Ve && (e.pageY < ct && Ue.m.up ? bt() : e.pageY > ct && Ue.m.down && wt()),
            ct = e.pageY
        }
        function vn(e, t, n) {
            var o, i, r = he(e, h), l = {
            ...
            F.onSlideLeave && !l.localIsResizing && "none" !== l.xMovement && Ee(F.onSlideLeave) && !1 === Xt("onSlideLeave", l) ? Re = !1 : (ce(t, c),
            ue(we(t), c),
            l.localIsResizing || (en(l.prevSlide),
            $t(t)),
            !F.loopHorizontal && F.controlArrows && (Te(K(U, r), 0 !== l.slideIndex),
            Te(K(X, r), null != ne(t))),
            Q(r, c) && !l.localIsResizing && kn(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex),
            function(e, t, n) {
                var o = t.destinyPos;
                if (F.css3) {
        ...
        function pn(e) {
            ...
            t = e.slidesNav,
            n = e.slideIndex,
            F.slidesNavigation && null != t && (ue(K(u, t), c),
            ce(K("a", K("li", t)[n]), c)),
            e.localIsResizing || (Ee(F.afterSlideLoad) && Xt("afterSlideLoad", e),
            Ve = !0,
            Jt(e.destiny)),
            Re = !1
        }
        function hn() {
            ...
            Be) {
                ...
                if (!xe(e, "textarea") && !xe(e, "input") && !xe(e, "select")) {
                    var n = G();
                    Math.abs(n - ut) > 20 * Math.max(ut, n) / 100 && (Tt(!0),
                    ut = n)
                }
            } else
                clearTimeout(We),
        ...
        function bn(e, t) {
            ...
            n = e,
            o = K(F.menu)[0],
            F.menu && null != o && (ue(K(u, o), c),
            ce(K('[data-menuanchor="' + n + '"]', o), c)),
            i = e,
            r = t,
            F.navigation && null != K(E)[0] && (ue(K(u, K(E)[0]), c),
            ce(i ? K('a[href="#' + i + '"]', K(E)[0]) : K("a", K("li", K(E)[0])[r]), c))
        }
        function wn(e) {
            var t = ie(K(g)[0], h)
              , n = ie(e, h);
        ...
        function Tn(e, t) {
            var n = xn(e);
            if (null != n) {
                var o, i, r, l = (null == (r = K(M + '[data-anchor="' + (o = t) + '"]', i = n)[0]) && (o = void 0 !== o ? o : 0,
                r = K(M, i)[o]),
                r);
        ...
        function kn(e, t, n, o) {
            var i = "";
            F.anchors.length && !F.lockAnchors && (e ? (null != n && (i = n),
            null == t && (t = e),
            Me = t,
            Mn(i + "/" + t)) : null != e ? (Me = t,
            Mn(n)) : Mn(n)),
        ...
        function Cn() {
            ...
            se.className = se.className.replace(r, ""),
            ce(se, s + "-" + i)
        }
        function Hn(e) {
            var t = [];
            ...
            ze && Pt(e) && F.scrollBar && void 0 !== e.touches && (t.y = e.touches[0].pageY,
        ...
        function jn() {
            J || (_("error", "Fullpage.js version 3 has changed its license to GPLv3 and it requires a `licenseKey` option. Read about it here:"),
            _("error", "https://github.com/alvarotrigo/fullPage.js#options.")),
            Q(K("html"), a) ? _("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (F.continuousVertical && (F.loopTop || F.loopBottom) && (F.continuousVertical = !1,
            _("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
            !F.scrollOverflow || !F.scrollBar && F.autoScrolling || _("warn", "Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox"),
            !F.continuousVertical || !F.scrollBar && F.autoScrolling || (F.continuousVertical = !1,
            _("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
            F.scrollOverflow && null == F.scrollOverflowHandler && (F.scrollOverflow = !1,
            _("error", "The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.")),
            ...
            F.anchors.forEach(function(e) {
                ...
                (n.length || t.length) && (_("error", "data-anchor tags can not have the same value as any `id` element on the site (or `name` element for IE)."),
                n.length && _("error", '"' + e + '" is is being used by another element `id` property'),
                t.length && _("error", '"' + e + '" is is being used by another element `name` property'))
            }))
        }
        function Pn(t, n, o, i) {
            var r, l = (r = t).self != e && Q(r, C) ? r.scrollLeft : !F.autoScrolling || F.scrollBar ? be() : r.offsetTop, a = n - l, s = 0;
            Ge = !0;
            var c = function() {
                if (Ge) {
                    var r = n;
